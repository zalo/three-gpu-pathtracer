import{a as w,R,F as E,E as B,x,z as D,v as T,l as f,ap as L,C as b,V as N,c as P,W,D as G,H as V,aX as H,aH as O,aM as C,av as X,a3 as j,aY as Y,aZ as $}from"./three.module-BlizGQtD.js";import{F as U,P as Q,h as Z,j as J,k as K}from"./pcg.glsl-Cm24kBub.js";import{a as k}from"./PathTracingRenderer-D_3xPivX.js";import{u as ee}from"./ggx_functions.glsl-BPuHaSoe.js";const p=new f,M=new f,g=new L,v=new b;class te extends w{constructor(e=512,t=512){super(new Float32Array(e*t*4),e,t,R,E,B,x,D,T,T),this.generationCallback=null}update(){this.dispose(),this.needsUpdate=!0;const{data:e,width:t,height:r}=this.image;for(let i=0;i<t;i++)for(let a=0;a<r;a++){M.set(t,r),p.set(i/t,a/r),p.x-=.5,p.y=1-p.y,g.theta=p.x*2*Math.PI,g.phi=p.y*Math.PI,g.radius=1,this.generationCallback(g,p,M,v);const n=4*(a*t+i);e[n+0]=v.r,e[n+1]=v.g,e[n+2]=v.b,e[n+3]=1}}copy(e){return super.copy(e),this.generationCallback=e.generationCallback,this}}const S=new N;class ae extends te{constructor(e=512){super(e,e),this.topColor=new b().set(16777215),this.bottomColor=new b().set(0),this.exponent=2,this.generationCallback=(t,r,i,a)=>{S.setFromSpherical(t);const s=S.y*.5+.5;a.lerpColors(this.bottomColor,this.topColor,s**this.exponent)}}copy(e){return super.copy(e),this.topColor.copy(e.topColor),this.bottomColor.copy(e.bottomColor),this}}class re extends P{get map(){return this.uniforms.map.value}set map(e){this.uniforms.map.value=e}get opacity(){return this.uniforms.opacity.value}set opacity(e){this.uniforms&&(this.uniforms.opacity.value=e)}constructor(e){super({uniforms:{map:{value:null},opacity:{value:1}},vertexShader:`
				varying vec2 vUv;
				void main() {
